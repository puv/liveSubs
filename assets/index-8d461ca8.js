...
function getConfig() {
  try {
    const config2 = localStorage.getItem("config");
    if (!config2) {
      localStorage.setItem("config", btoa(JSON.stringify(Config)));
      return Config;
    }
    const bytesConfig = atob(config2);
...
const saveConfig = (config2) => {
  let stringConfig = JSON.stringify(config2);
...
const deleteTranslation = (e) => {
  ...
  let newConfig = {
    ...config2,
    ["translations"]: config2["translations"].filter((_, i) => i !== parseInt(e.target.getAttribute("name").split(".")[1]))
  };
  saveConfig(newConfig);
};
var jquery = { exports: {} };
...
const Dictionary = {
  ...
  "api_google_get": {
    "en": "API Key is optional. <a target='_blank' href='https://cloud.google.com/translate/docs/getting-started'>Click here to get one.</a>",
    "ja": "APIキーはオプションです。<a target='_blank' href='https://cloud.google.com/translate/docs/getting-started'>ここをクリックして取得してください。</a>",
    "ko": "API 키는 선택 사항입니다. <a target='_blank' href='https://cloud.google.com/translate/docs/getting-started'>여기를 클릭하여 하나를 받으십시오.</a>",
    "zh": "API密钥是可选的。 <a target='_blank' href='https://cloud.google.com/translate/docs/getting-started'>点击此处获取。</a>"
  },
  "api_deepl_get": {
    "en": "API Key is needed. <a target='_blank' href='https://www.deepl.com/pro-api?cta=header-pro-api'>Click here to get one.</a>",
    "ja": "APIキーが必要です。<a target='_blank' href='https://www.deepl.com/pro-api?cta=header-pro-api'>ここをクリックして取得してください。</a>",
    "ko": "API 키가 필요합니다. <a target='_blank' href='https://www.deepl.com/pro-api?cta=header-pro-api'>여기를 클릭하여 하나를 받으십시오.</a>",
    "zh": "需要API密钥。 <a target='_blank' href='https://www.deepl.com/pro-api?cta=header-pro-api'>点击此处获取。</a>"
  },
  "local": {
    "en": "Local",
    "ja": "ローカル",
  ...
  "api_explained": {
    "en": "If you don't know what this is, follow the instructions <a target='_blank' href='http://www.sayonari.com/trans_asr/index_asr.html'>by clicking here</a>",
    "ja": "これが何であるかわからない？<a target='_blank' href='http://www.sayonari.com/trans_asr/index_asr.html'>ここをクリックして指示に従ってください。</a>",
  ...
  "credits": [
    {
      ...
      "ja": "更新者 <a target='_blank' href='https://github.com/puv'>@puv</a>",
      "ko": "업데이트 <a target='_blank' href='https://github.com/puv'>@puv</a>",
      "zh": "更新者 <a target='_blank' href='https://github.com/puv'>@puv</a>"
    },
    {
      "en": "Original version by <a target='_blank' href='https://github.com/sayonari'>@sayonari</a>",
      "ja": "オリジナルバージョン <a target='_blank' href='https://github.com/sayonari'>@sayonari</a>",
      "ko": "원래 버전 <a target='_blank' href='https://github.com/sayonari'>@sayonari</a>",
      "zh": "原始版本 <a target='_blank' href='https://github.com/sayonari'>@sayonari</a>"
    }
  ],
  "bottomText": {
    ...
    "zh": "警告：使用API密钥的翻译可能无法正常工作。 我们建议使用没有API密钥的Google。 如果遇到问题，<a target='blank' href='https://github.com/puv/liveSubs/issues'>请在此处报告。</a>"
  },
...
function prettyTime(milliseconds) {
  ...
  let milliseconds_remainder = milliseconds % 1e3;
  seconds %= 60;
  minutes %= 60;
  hours %= 24;
...
function BaseConfig({ config: config2 }) {
  const [inputDevices, setInputDevices] = reactExports.useState([]);
  const [outputDevices, setOutputDevices] = reactExports.useState([]);
  const handleInput = (e) => {
  ...
  const handleDevice = (e) => {
    switch (e.target.id) {
      case "inputDevice":
        config2.input_device = e.target.value;
        ...
        break;
      case "outputDevice":
        config2.output_device = e.target.value;
        saveConfig(config2);
        break;
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["api_type"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["api_key"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["server_mode"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["input_device"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["output_device"][config2.lang] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "apiType", onChange: handleInput, name: "api.type", value: config2.api.type, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "local", disabled: true, children: "Local" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "libre", children: "Libre Translate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "google", children: "Google" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "deepl", disabled: true, children: "DeepL" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            size: 60,
            onInput: handleInput,
            disabled: config2.api.type == "local" || config2.api.type == "libre"
          }
        ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { id: "inputDevice", onChange: handleDevice, disabled: true, value: config2.input_device, name: "input_device", style: {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: device.deviceId, children: device.label }, device.deviceId);
      }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { id: "outputDevice", onChange: handleDevice, disabled: true, value: config2.output_device, name: "output_device", style: {
        maxWidth: "15em"
      }, children: outputDevices.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: Dictionary["no_output_device"][config2.lang] }) : outputDevices.map((device) => {
        return /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: device.deviceId, children: device.label }, device.deviceId);
      }) }) })
    ] }) })
  ] });
...
function ExtraConfig({ config: config2 }) {
  const handleInput = (e) => {
    const newConfig = { ...config2 };
    const keys = e.target.name.split(".");
    log(e.target.name, e.target.value);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["type"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["positionH"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["positionV"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["whiteSpace"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["deleteSentenceTimer"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["newSentenceTimer"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["langNames"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["bouyomiChan"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["wordCensor"][config2.lang] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: Dictionary["text"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "TextHAlign", onChange: handleInput, name: "pos_h", value: config2.pos_h, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "left", children: Dictionary["left"][config2.lang] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "center", children: Dictionary["center"][config2.lang] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "right", children: Dictionary["right"][config2.lang] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "TextVAlign", onChange: handleInput, name: "pos_v", value: config2.pos_v, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "top", children: Dictionary["top"][config2.lang] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "bottom", children: Dictionary["bottom"][config2.lang] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "WhiteSpace", onChange: handleInput, name: "white_space", value: config2.white_space, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "normal", children: Dictionary["normal"][config2.lang] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "nowrap", children: Dictionary["nowrap"][config2.lang] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { id: "_DeleteTimer", children: config2.delete_timer }),
        "ms"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { id: "_PauseTimer", children: config2.pause_timer }),
        "ms"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", id: "LangNames", onChange: handleInput, checked: config2.lang_names, name: "lang_names" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", id: "ChatReader", onChange: handleInput, disabled: true, checked: config2.reader_support, name: "reader_support" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", id: "WordCensor", onChange: handleInput, disabled: true, checked: config2.word_censor, name: "word_censor" }) })
    ] }) })
  ] });
}
const Fonts = [
...
const Languages = [
  ...
  if (a.name.native < b.name.native)
    return -1;
  if (a.name.native > b.name.native)
    return 1;
  return 0;
...
function MainConfig({ config: config2 }) {
  const handleInput = (e) => {
    const newConfig = { ...config2 };
    const keys = e.target.name.split(".");
    log(e.target.name, e.target.value);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { id: "translationTable", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["type"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["color"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["border"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["size"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["weight"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["borderWeight"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["lang"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["font"][config2.lang] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: Dictionary["delete"][config2.lang] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: Dictionary["background"][config2.lang] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "bgColor", type: "color", value: config2.bg_color, name: "bg_color", onInput: handleInput }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: Dictionary["subtitle"][config2.lang] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "SubColor", type: "color", value: config2.sub.color, name: "sub.color", onInput: handleInput }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "SubBorderColor", type: "color", value: config2.sub.border_color, name: "sub.border_color", onInput: handleInput }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { id: "_SubSize", children: config2.sub.size }),
          "pt"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { id: "_SubWeight", children: config2.sub.weight })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "SubBorderWidth",
              type: "range",
              value: config2.sub.border_width,
              min: "0",
              max: "20",
              step: "1",
              name: "sub.border_width",
              onInput: handleInput
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { id: "_SubBorderWidth", children: config2.sub.border_width }),
          "pt"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { id: "SubLang", onChange: handleInput, name: "sub.lang", value: config2.sub.lang, children: Languages.map((lang) => {
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: lang.code, children: [
            lang.name.native,
            " (",
            lang["name"][config2.lang],
            ")"
          ] }, lang.code);
        }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { id: "SubFont", onChange: handleInput, name: "sub.font", value: config2.sub.font, children: Fonts.map((font) => {
          return /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: font.code, children: font.name }, font.code);
        }) }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: config2["translations"].map((_, i) => TranslationOption(i, config2, handleInput, deleteTranslation)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: config2["translations"].length < 5 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 9, id: "addTranslation", onClick: addTranslation, children: Dictionary["add_translation"][config2.lang] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {}) })
  ] });
}
function TranslationOption(number, config2, handleInput, deleteTranslation2) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
      Dictionary["translation"][config2.lang],
      " ",
      number + 1
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "color", value: config2.translations[number].color, name: `translations.${number}.color`, onInput: handleInput }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "color", value: config2.translations[number].border_color, name: `translations.${number}.border_color`, onInput: handleInput }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "range",
          value: config2.translations[number].size,
          min: "0",
          max: "72",
          step: "1",
          name: `translations.${number}.size`,
          onInput: handleInput
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: config2.translations[number].size }),
      "pt"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          type: "range",
          value: config2.translations[number].weight,
          min: "100",
          max: "900",
          step: "100",
          name: `translations.${number}.weight`,
          onInput: handleInput
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: config2.translations[number].weight })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "range",
          value: config2.translations[number].border_width,
          min: "0",
          max: "20",
          step: "1",
          name: `translations.${number}.border_width`,
          onInput: handleInput
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: config2.translations[number].border_width }),
      "pt"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { onChange: handleInput, name: `translations.${number}.lang`, value: config2.translations[number].lang, children: Languages.map((lang) => {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: lang.code, children: [
        lang.name.native,
        " (",
        lang["name"][config2.lang],
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { id: "SubFont", onChange: handleInput, name: `translations.${number}.font`, value: config2.translations[number].font, children: Fonts.map((font) => {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: font.code, children: font.name }, font.code);
    }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: deleteTranslation2, name: `translations.${number}`, children: "X" }) })
  ] }, number);
}
Overlay.propTypes = {
  config: PropTypes.object.isRequired
};
function Overlay({ config: config2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "settings", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(BaseConfig, { config: config2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MainConfig, { config: config2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ExtraConfig, { config: config2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(OverlayFooter, { config: config2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { dangerouslySetInnerHTML: { __html: Dictionary["bottomText"][config2.lang] } })
  ] }) });
}
OverlayFooter.propTypes = {
  config: PropTypes.object.isRequired
};
function OverlayFooter({ config: config2 }) {
  const setLanguage = (e) => {
    const newConfig = {
      ...config2,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "button closeButton btn_success", onClick: () => {
        $("#overlay").css("display", "none");
      }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { children: Dictionary["close"][config2.lang] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "button resetButton btn_error", onClick: () => {
        saveConfig(getNewConfig());
      }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { children: Dictionary["reset"][config2.lang] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "credits", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { dangerouslySetInnerHTML: { __html: Dictionary["credits"][0][config2.lang] } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { dangerouslySetInnerHTML: { __html: Dictionary["credits"][1][config2.lang] } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "button downloadButton btn_info", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { dangerouslySetInnerHTML: { __html: Dictionary["download"][config2.lang] } }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "language", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "button langButton btn_neutral", "data-name": "en", onClick: setLanguage, children: "English" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "button langButton btn_neutral", "data-name": "ja", onClick: setLanguage, children: "日本語" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "button langButton btn_neutral", "data-name": "ko", onClick: setLanguage, children: "한국인" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "button langButton btn_neutral", "data-name": "zh", onClick: setLanguage, children: "中國人" })
    ] })
  ] });
}
Subtitle.propTypes = {
...
function Subtitle({ config: config2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      id: "Subtitle",
      style: {
        fontSize: `${config2.sub.size}pt`,
        fontFamily: config2.sub.font,
        fontWeight: config2.sub.weight,
        textAlign: config2.pos_h,
        minHeight: `${config2.sub.size}pt`
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            id: "SubBGText",
            style: {
              WebkitTextStroke: `${config2.sub.border_width}pt ${config2.sub.border_color}`
            },
            children: Dictionary["subtitle"][config2.lang]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
...
function Translation({ config: config2, index }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      id: "Translation",
      "data-tr": index,
      "data-lang": config2.translations[index].lang,
      style: {
        fontSize: `${config2.translations[index].size}pt`,
        fontFamily: config2.translations[index].font,
        fontWeight: config2.translations[index].weight,
        textAlign: config2.pos_h,
        minHeight: `${config2.translations[index].size}pt`
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "data-tr": index,
            style: {
              WebkitTextStroke: `${config2.translations[index].border_width}pt ${config2.translations[index].border_color}`
            },
            children: Dictionary["translation"][config2.lang] + " " + (index + 1)
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "data-tr": index,
            style: {
              color: config2.translations[index].color
            },
            children: Dictionary["translation"][config2.lang] + " " + (index + 1)
          }
        )
...
BouyomiChanClient.prototype.makeBouyomiChanDataToSend = function(text) {
  ...
  let pos = 0;
  data[pos++] = command & 255;
  data[pos++] = command >> 8 & 255;
  data[pos++] = speed & 255;
  data[pos++] = speed >> 8 & 255;
  data[pos++] = tone & 255;
  data[pos++] = tone >> 8 & 255;
  data[pos++] = volume & 255;
  data[pos++] = volume >> 8 & 255;
  data[pos++] = voice & 255;
  data[pos++] = voice >> 8 & 255;
  data[pos++] = code & 255;
  data[pos++] = len & 255;
  data[pos++] = len >> 8 & 255;
  data[pos++] = len >> 16 & 255;
...
const handleTranslation = (config2, text) => {
  let targetLangs = config2.translations.map((translation) => translation.lang);
  log("[ FINAL ]", text);
  switch (config2.api.type) {
    case "local":
      break;
    case "libre":
      translateLibre(config2, text, targetLangs);
      break;
    case "google":
      translateGoogle(config2, text, targetLangs);
      break;
    case "deepl":
      translateDeepl(config2, text, targetLangs);
      break;
  }
};
const translateLibre = (config2, text, targetLangs) => {
  for (let i = 0; i < targetLangs.length; i++) {
    let request = new XMLHttpRequest();
    let query = "http://srv.puv.bar:5000/translate";
    let body = {
      q: text,
      source: config2.sub.lang,
    ...
    request.onreadystatechange = function() {
      if (request.readyState === 4 && request.status === 200) {
        ...
        $(`#TFg[data-tr="${i}"]`)[0].innerText = `${config2.lang_names ? `[${targetLangs[i].toUpperCase()}] ` : ""}${translation}`;
        $(`#TBg[data-tr="${i}"]`)[0].innerText = `${config2.lang_names ? `[${targetLangs[i].toUpperCase()}] ` : ""}${translation}`;
      }
    };
  }
};
const translateGoogle = (config2, text, targetLangs) => {
  for (let i = 0; i < targetLangs.length; i++) {
    let request = new XMLHttpRequest();
    let query;
    if (config2.api.key.length != 0) {
      query = "https://translation.googleapis.com/language/translate/v2?key=" + config2.api.key + "&source=" + config2.sub.lang + "&target=" + targetLangs[i] + "&q=" + encodeURI(text);
    } else {
      query = "https://translate.googleapis.com/translate_a/single?client=gtx&sl=" + config2.sub.lang + "&tl=" + targetLangs[i] + "&dt=t&q=" + encodeURI(text);
    }
...
const translateDeepl = (config2, text, targetLangs) => {
  if (config2.api.key.length <= 0)
    return;
  for (let i = 0; i < targetLangs.length; i++) {
    let request = new XMLHttpRequest();
    let query = "https://api-free.deepl.com/v2/translate?auth_key=" + config2.api.key + "&text=" + encodeURI(text) + "&source_lang=" + config2.sub.lang + "&target_lang=" + targetLangs[0];
    request.open("GET", query, true);
    request.onreadystatechange = function() {
      if (request.readyState === 4 && request.status === 200) {
        let response = JSON.parse(request.responseText);
...
const useAudioDevice = (config2) => {
  log("Using audio device", config2.input_device);
  navigator.mediaDevices.getUserMedia({
    audio: {
      deviceId: {
        exact: config2.input_device
      }
    }
  }).then((stream) => {
...
function TranslationApp({ config: config2 }) {
  reactExports.useEffect(() => {
    if (document.readyState === "complete") {
      handleAudio();
    } else {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      id: "App",
      style: {
        backgroundColor: config2.bg_color
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          id: "wrapper",
          style: {
            top: config2.pos_v == "top" ? "0" : "unset",
            bottom: config2.pos_v == "bottom" ? "0" : "unset",
            whiteSpace: config2.white_space,
            gridTemplateRows: `repeat(${config2.translations.length + 1}, auto)`
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Subtitle, { config: config2 }),
            config2.translations.map((_translation, index) => {
              return /* @__PURE__ */ jsxRuntimeExports.jsx(Translation, { config: config2, index }, index);
            })
          ]
        }
      )
...
function App$1() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TranslationApp, { config: config2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Overlay, { config: config2 })
  ] });
}
function App() {
  const [config2, setConfig] = reactExports.useState(getConfig());
      ...
      switch (msg.type) {
        ...
        case "speech":
          if (msg.data.final == true) {
            ...
            handleTranslation(config2, msg.data.text);
          } else {
            $("#SubBGText")[0].innerText = "<< " + msg.data.text + " >>";
            $("#SubFGText")[0].innerText = "<< " + msg.data.text + " >>";
          }
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/client", element: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }),
